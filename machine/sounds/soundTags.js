...
const backSFX         = new Audio(sfx.button_back);     backSFX.volume = 0.3;
const closeSFX        = new Audio(sfx.button_close);    closeSFX.volume = 0.3;
const confirmSFX      = new Audio(sfx.button_confirm);  confirmSFX.volume = 0.3;
