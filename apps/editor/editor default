...
function infoModeWarning(){
  ...
  hyperWarning.innerHTML = 'O Modo informativo esta ativado, apartir de agora se o cursor estiver em cima de algo que necessita de informações ira aparecer uma caixa proximo ao cursor informando o que aquele destaque faz e até dando dicas de como usar-lo.'
